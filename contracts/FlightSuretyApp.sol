...
contract FlightSuretyApp {
    ...
    uint8 private constant STATUS_CODE_LATE_OTHER = 50;
     ...
     event ResgisterAirlineEvent(address airline, string flight,uint256 registeredAirlineCount);
  ...
  modifier requireIsAirlineActive()
    ...
    function registerAirline(address airlineAddress, string memory airlineName)
        ...
        returns (bool)
    {
        bool _success = flightSuretyData.registerAirline(airlineAddress, airlineName);
        if(_success){
        emit ResgisterAirlineEvent(airlineAddress, airlineName,flightSuretyData.getRegisteredAirlineCount());
        }
        return _success;
    }

    function submitAirlineVote(address airlineAddress)
        public
        requireIsOperational
...
contract FlightSuretyData {
    ...
    function withdraw (address  insuredPassenger) public ;
    function getRegisteredAirlineCount() public view returns (uint256 count);
    function submitAirlineVote(address airlineAddress) external ;
